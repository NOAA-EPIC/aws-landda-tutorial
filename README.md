...
Once users are connected to the Utility host, run the packer build script
wget https://github.com/NOAA-EPIC/aws-landda-tutorial/blob/main/build-utility.sh
and run "build-utility.sh" as follows to install git and hashicorp utility packer 
>> ./build-utility.sh
...
Other relevant information can be found in *da_hpc.yaml*.
